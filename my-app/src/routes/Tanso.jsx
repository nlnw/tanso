...
export default function Tanso() {
  const [wcState, setWcState] = useState(""); // TODO: use wcState for attestations.
        ...
        >
          ...
          <div className="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
            ...
            <div className="flex flex-row items-center justify-end gap-2">
              ...
              <IDKitWidget
                app_id="app_22a3d5746c13baaadf35ff0239ca84c8" // obtain this from developer.worldcoin.org
                action="my_action"
                enableTelemetry
                onSuccess={(result) => setWcState(result)} // pass the proof to the API or your smart contract
              >
                {({ open }) => (
                  <span className="cursor-pointer" onClick={open}>
                    <svg
                      class="text-0d151d h-8 dark:text-white"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 33 32"
                    >
      ...
      >
        ...
        >
          <ul className="space-y-1.5">
            ...
            <li>
              <hr className="h-1 mx-auto bg-gray-100 border-0 rounded my-5 dark:bg-gray-700" />
            </li>
            <li>
              <img src={EthGlobal} className="logo" alt="Vite logo" />
            </li>
          </ul>
        </nav>
      </div>
